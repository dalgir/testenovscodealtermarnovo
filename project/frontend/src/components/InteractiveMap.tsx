      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            {/* Business Hours */}
            <AnimatedSection animation="slideUp" className="bg-white dark:bg-gray-700 rounded-2xl shadow-lg p-8">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <button
                  onClick={handleGetDirections}
                  className="bg-blue-900 text-white p-4 rounded-xl hover:bg-blue-800 transition-colors flex flex-col items-center"
                >
                ...
                <button
                  ...
                  className="bg-green-600 text-white p-4 rounded-xl hover:bg-green-700 transition-colors flex flex-col items-center"
                >
